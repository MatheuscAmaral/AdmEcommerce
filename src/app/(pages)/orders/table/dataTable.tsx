            ...
            {table
              ...
              .map((column) => {
                return (
                  ...
                  >
                    {column.id == "order_id" && "Código"}

                    {column.id == "total" && "Total"}

                    {column.id == "discounts" && "Descontos"}

                    {column.id == "client_id" && "Cliente"}

                    {column.id == "shipping_cost" && "Frete"}

                    {column.id == "payment_method" && "Forma de pagamento"}

                    {column.id == "zip_code" && "Cep"}

                    {column.id == "street" && "Rua"}
