...
import ModalCreateGateway from "@/app/components/modals/modalCreateGateway";

interface DataProps {
  data: Array<IGateways>;
  columns: ColumnDef<IGateways, any>[]
}
    ...
    <div className="w-full">
      <div className="flex items-center py-4">
        <div className="relative w-full max-w-96">
          <Input
            placeholder="Pesquisar pela descrição do gateway..."
